...
void CCameraComponent::Start(SHARED(CComponent) spThis)
{
	...
	GET_VALUE(true, m_dataID, m_name, L"m_moveSpeed", m_moveSpeed);
	GET_VALUE(true, m_dataID, m_name, L"m_mouseSensitivity", m_mouseSensitivity);
	GET_VALUE(true, m_dataID, m_name, L"m_near", m_near);
	GET_VALUE(true, m_dataID, m_name, L"m_far", m_far);
	GET_VALUE(true, m_dataID, m_name, L"m_fov", m_fov);
